...
**Core:** Erc6909  **-->** **`$pwd`:** [/contracts/src/token/erc6909/erc6909.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/src/token/erc6909/erc6909.rs)
...
**Supply Extension:** Erc6909Supply **-->** **`$pwd`:** [/contracts/src/token/erc6909/extensions/token_supply.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/src/token/erc6909/extensions/token_supply.rs)
...
**Metadata Extension:** Erc6909MetadataUri  **-->** **`$pwd`:** [/contracts/src/token/erc6909/extensions/metadata_uri.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/src/token/erc6909/extensions/metadata_uri.rs)
...
**Enumerable Extension:** Erc6909Enumerable **-->** **`$pwd`:** [/contracts/src/token/erc6909/extensions/enumerable.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/src/token/erc6909/extensions/enumerable.rs)
...
- **Unit Tests (Native):** -->  **`$pwd`:** [/contracts/src/token/erc6909/erc6909.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/src/token/erc6909/erc6909.rs).
  
`#[cfg(test)]` modules driven by `TestVM`, using `motsu::test` for consistency.

- **Examples & Integration:** **`$pwd`:** [/contracts/examples/](https://github.com/apalpadorDEV/erc6909_draft/tree/main/contracts/examples) :
     ```bash
    total 16
...
- **Benchmarks:** **`$pwd`:** [/contracts/benches/](https://github.com/apalpadorDEV/erc6909_draft/tree/main/contracts/benches) : 
...
- [/contracts/src/token/erc6909/erc6909.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/src/token/erc6909/erc6909.rs)
- [/contracts/src/token/erc6909/extensions/token_supply.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/src/token/erc6909/extensions/token_supply.rs)
- [/contracts/src/token/erc6909/extensions/metadata_uri.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/src/token/erc6909/extensions/metadata_uri.rs)
- [/contracts/src/token/erc6909/extensions/enumerable.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/src/token/erc6909/extensions/enumerable.rs)
- [/contracts/benches/erc6909_core.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/benches/erc6909_core.rs)
- [/contracts/benches/erc6909_enumerable.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/benches/erc6909_enumerable.rs)
- [/contracts/benches/erc6909_metadata.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/benches/erc6909_metadata.rs)
- [/contracts/benches/erc6909_supply.rs](https://github.com/apalpadorDEV/erc6909_draft/blob/main/contracts/benches/erc6909_supply.rs)
